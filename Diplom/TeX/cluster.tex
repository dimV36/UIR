...
\node[block] (ca) {
	\begin{tabular}{C{7.4cm}}
		\rowcolor{blue!30}
		\textbf{\begin{tabular}[c]{@{}c@{}}\Large Удостоверяющий центр\\ \large IP: 192.168.100.4\end{tabular}} \\                                                   
	\end{tabular}
};
...
\node[block] (postgresql) [below left of=ca, node distance = 15cm] {
	\begin{tabular}{C{7.4cm}}
		\rowcolor{blue!30}
		\textbf{\begin{tabular}[c]{@{}c@{}}\Large PostgreSQL\\ \Large IP: 192.168.100.2\end{tabular}} \\
		\rowcolor{blue!15}
