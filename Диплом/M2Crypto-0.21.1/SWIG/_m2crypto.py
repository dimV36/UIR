...
class _STACK(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, _STACK, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, _STACK, name)
    __repr__ = _swig_repr
    __swig_setmethods__["num"] = __m2crypto._STACK_num_set
    __swig_getmethods__["num"] = __m2crypto._STACK_num_get
    if _newclass:num = _swig_property(__m2crypto._STACK_num_get, __m2crypto._STACK_num_set)
    __swig_setmethods__["data"] = __m2crypto._STACK_data_set
    __swig_getmethods__["data"] = __m2crypto._STACK_data_get
    if _newclass:data = _swig_property(__m2crypto._STACK_data_get, __m2crypto._STACK_data_set)
    __swig_setmethods__["sorted"] = __m2crypto._STACK_sorted_set
    __swig_getmethods__["sorted"] = __m2crypto._STACK_sorted_get
    if _newclass:sorted = _swig_property(__m2crypto._STACK_sorted_get, __m2crypto._STACK_sorted_set)
    __swig_setmethods__["num_alloc"] = __m2crypto._STACK_num_alloc_set
    __swig_getmethods__["num_alloc"] = __m2crypto._STACK_num_alloc_get
    if _newclass:num_alloc = _swig_property(__m2crypto._STACK_num_alloc_get, __m2crypto._STACK_num_alloc_set)
    __swig_setmethods__["comp"] = __m2crypto._STACK_comp_set
    __swig_getmethods__["comp"] = __m2crypto._STACK_comp_get
    if _newclass:comp = _swig_property(__m2crypto._STACK_comp_get, __m2crypto._STACK_comp_set)
    def __init__(self): 
        this = __m2crypto.new__STACK()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = __m2crypto.delete__STACK
    __del__ = lambda self : None;
_STACK_swigregister = __m2crypto._STACK_swigregister
_STACK_swigregister(_STACK)
...
class stack_st_OPENSSL_STRING(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, stack_st_OPENSSL_STRING, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, stack_st_OPENSSL_STRING, name)
    __repr__ = _swig_repr
    __swig_setmethods__["stack"] = __m2crypto.stack_st_OPENSSL_STRING_stack_set
    __swig_getmethods__["stack"] = __m2crypto.stack_st_OPENSSL_STRING_stack_get
    if _newclass:stack = _swig_property(__m2crypto.stack_st_OPENSSL_STRING_stack_get, __m2crypto.stack_st_OPENSSL_STRING_stack_set)
    def __init__(self): 
        this = __m2crypto.new_stack_st_OPENSSL_STRING()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = __m2crypto.delete_stack_st_OPENSSL_STRING
    __del__ = lambda self : None;
stack_st_OPENSSL_STRING_swigregister = __m2crypto.stack_st_OPENSSL_STRING_swigregister
stack_st_OPENSSL_STRING_swigregister(stack_st_OPENSSL_STRING)

class stack_st_OPENSSL_BLOCK(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, stack_st_OPENSSL_BLOCK, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, stack_st_OPENSSL_BLOCK, name)
    __repr__ = _swig_repr
    __swig_setmethods__["stack"] = __m2crypto.stack_st_OPENSSL_BLOCK_stack_set
    __swig_getmethods__["stack"] = __m2crypto.stack_st_OPENSSL_BLOCK_stack_get
    if _newclass:stack = _swig_property(__m2crypto.stack_st_OPENSSL_BLOCK_stack_get, __m2crypto.stack_st_OPENSSL_BLOCK_stack_set)
    def __init__(self): 
        this = __m2crypto.new_stack_st_OPENSSL_BLOCK()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = __m2crypto.delete_stack_st_OPENSSL_BLOCK
    __del__ = lambda self : None;
stack_st_OPENSSL_BLOCK_swigregister = __m2crypto.stack_st_OPENSSL_BLOCK_swigregister
stack_st_OPENSSL_BLOCK_swigregister(stack_st_OPENSSL_BLOCK)
...
NID_netscape_comment = __m2crypto.NID_netscape_comment

def x509v3_ext_add_alias(*args):
  return __m2crypto.x509v3_ext_add_alias(*args)
x509v3_ext_add_alias = __m2crypto.x509v3_ext_add_alias

def x509v3_ext_conf_nid(*args):
  return __m2crypto.x509v3_ext_conf_nid(*args)
x509v3_ext_conf_nid = __m2crypto.x509v3_ext_conf_nid
...
def obj_create(*args):
  return __m2crypto.obj_create(*args)
obj_create = __m2crypto.obj_create
