...
SWIGINTERN PyObject *_wrap_obj_create(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "obj_create" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
  res2 = SWIG_AsCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "obj_create" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = (char *)(buf2);
  res3 = SWIG_AsCharPtrAndSize(obj2, &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "obj_create" "', argument " "3"" of type '" "char const *""'");
  }
  arg3 = (char *)(buf3);
  {
    if (!arg1) {
  ...
  result = (int)OBJ_create((char const *)arg1,(char const *)arg2,(char const *)arg3);
  {
    resultobj=PyInt_FromLong(result);
    if (PyErr_Occurred()) SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_add_ext(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  X509 *arg1 = (X509 *) 0 ;
  int arg2 ;
  char *arg3 = (char *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:add_ext",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_X509, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "add_ext" "', argument " "1"" of type '" "X509 *""'"); 
  }
  arg1 = (X509 *)(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "add_ext" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  res3 = SWIG_AsCharPtrAndSize(obj2, &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "add_ext" "', argument " "3"" of type '" "char *""'");
  }
  arg3 = (char *)(buf3);
  {
    if (!arg1) {
  ...
  result = (int)add_ext(arg1,arg2,arg3);
  {
    resultobj=PyInt_FromLong(result);
    if (PyErr_Occurred()) SWIG_fail;
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"add_ext", _wrap_add_ext, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
